...
internal class Program
{
    private static void Main(string[] args)
    {
         ...
         */
        int maximo = 0, minimo = 0, cantidad = 0;
        ...
        /*Aqui muestro el arreglo de numeros generados aleatoriamente con un rango minimo y maximo, 
         * ademas con un tamaño definido en el arreglo por el usuario y que los numeros no sean repetidos.
        */
